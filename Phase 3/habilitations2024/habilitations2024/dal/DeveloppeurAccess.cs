...
namespace habilitations2024.dal
{
    ...
    public class DeveloppeurAccess
    {
        ...
        public List<Developpeur> GetLesDeveloppeurs(string profilselected)
        {
            List<Developpeur> lesDeveloppeurs = new List<Developpeur>();
            if (access.Manager != null)
            {
                string req = string.Empty;
                string reqtest = string.Empty;

                if (profilselected == "" || profilselected == null)
                {
                    req += "select d.iddeveloppeur as iddeveloppeur, d.nom as nom, d.prenom as prenom, d.tel as tel, d.mail as mail, p.idprofil as idprofil, p.nom as profil ";
                ...
                else
                {
                    req += "select d.iddeveloppeur as iddeveloppeur, d.nom as nom, d.prenom as prenom, d.tel as tel, d.mail as mail, p.idprofil as idprofil, p.nom as profil ";
                    req += "from developpeur d join profil p on (d.idprofil = p.idprofil) ";
                    req += $"where p.nom = '{profilselected}' ";
                    req += "order by nom, prenom;";
                }
